...
@Getter
public class UpdateUserByAdminRequestDtoV1 {

    @Schema(description = "유저 넘버", example = "2")
    ...
    @Schema(description = "롤 설졍", example = "MANEGER")
    private final UserRoleEnum role;

    @Schema(description = "유저 삭제 여부", example = "false", nullable = true)
    private final Boolean deleted;

    public UpdateUserByAdminRequestDtoV1(String userName, String userId,String userPhone, String email, String newPassword,UserRoleEnum role, Boolean deleted) {
