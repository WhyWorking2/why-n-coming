...
@Getter
public class CreateStoreOwnerResponseV1 {
    ...
    public CreateStoreOwnerResponseV1(UUID storeId, String storeName, String storeLogoUrl, String storeImageUrl, Integer minDeliveryPrice, Integer deliveryTip) {
