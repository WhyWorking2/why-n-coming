...
----------------------------
INSERT INTO products (product_seq, store_id, product_name, description, price, product_picture_url, created_date, modified_date)
VALUES
...
----------------------------
INSERT INTO categories (category_seq, category_name, created_date, modified_date, deleted_date)
VALUES
...
--    PK 이름: category_product_seq (스키마 기준), created/modified 필수
----------------------------
INSERT INTO category_stores (category_product_seq, store_id, category_seq, created_date, modified_date, deleted_date)
VALUES
...
----------------------------
INSERT INTO category_products (categorystore_id, product_seq, category_seq, created_date, modified_date, deleted_date)
VALUES
...
----------------------------
INSERT INTO orders (order_seq, store_id, user_no, payment_method, total_price, requests, created_date, modified_date, status, deleted_date)
VALUES
...
----------------------------
INSERT INTO carts (cart_seq, store_id, order_seq, product_seq, quantity, user_no, created_date, modified_date)
VALUES
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE001'), (SELECT id FROM order_map WHERE code='ORDER001'), (SELECT id FROM prod_map WHERE code='PROD001'), 2,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER001')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE002'), (SELECT id FROM order_map WHERE code='ORDER002'), (SELECT id FROM prod_map WHERE code='PROD002'), 1,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER002')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE003'), (SELECT id FROM order_map WHERE code='ORDER003'), (SELECT id FROM prod_map WHERE code='PROD003'), 3,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER003')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE004'), (SELECT id FROM order_map WHERE code='ORDER004'), (SELECT id FROM prod_map WHERE code='PROD004'), 1,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER004')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE005'), (SELECT id FROM order_map WHERE code='ORDER005'), (SELECT id FROM prod_map WHERE code='PROD005'), 2,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER005')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE006'), (SELECT id FROM order_map WHERE code='ORDER006'), (SELECT id FROM prod_map WHERE code='PROD006'), 2,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER006')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE007'), (SELECT id FROM order_map WHERE code='ORDER007'), (SELECT id FROM prod_map WHERE code='PROD007'), 1,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER007')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE008'), (SELECT id FROM order_map WHERE code='ORDER008'), (SELECT id FROM prod_map WHERE code='PROD008'), 3,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER008')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE009'), (SELECT id FROM order_map WHERE code='ORDER009'), (SELECT id FROM prod_map WHERE code='PROD009'), 4,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER009')), NOW(), NOW()),
    (gen_random_uuid(), (SELECT id FROM store_map WHERE code='STORE010'), (SELECT id FROM order_map WHERE code='ORDER010'), (SELECT id FROM prod_map WHERE code='PROD010'), 2,
     (SELECT user_no FROM orders WHERE order_seq = (SELECT id FROM order_map WHERE code='ORDER010')), NOW(), NOW());

-- 가격 정합성 보정
UPDATE orders o
SET total_price = c.total
    FROM (
    SELECT o.order_seq, SUM(p.price * c.quantity) AS total
    FROM orders o
    JOIN carts c   ON o.order_seq = c.order_seq
    JOIN products p ON c.product_seq = p.product_seq
    GROUP BY o.order_seq
) c
WHERE o.order_seq = c.order_seq;

----------------------------
-- 11) 배달 (deliveries)  ※ delivery_status 체크값 매핑
-- '배송중'→'DELIVERING', '배송완료'→'DELIVERED', '대기중'→'ACCEPTED'
----------------------------
INSERT INTO deliveries (delivery_seq, order_id, user_no, address_id, delivery_status, "position", created_date, modified_date, deleted_date)
VALUES
...
-- 12) 리뷰 (reviews)
----------------------------
INSERT INTO reviews (review_seq, order_seq, store_id, user_no, review_rating, review_content, review_picture_url, created_date, modified_date, deleted_date)
VALUES
...
----------------------------
INSERT INTO owner_reviews (owner_review_seq, review_seq, user_no, owner_review_content, created_date, modified_date, deleted_date)
VALUES
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER001')),  2, '리뷰 감사합니다!',          NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER002')),  2, '다음에도 이용해주세요.',    NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER003')), 11, '항상 최선을 다하겠습니다.', NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER004')),  2, '소중한 의견 감사합니다.',   NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER005')),  2, '좋은 하루 되세요!',        NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER006')), 11, '더 노력하겠습니다.',        NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER007')), 11, '리뷰 감사합니다!',          NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER008')), 11, '만족하셨다니 기쁩니다.',    NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER009')),  2, '리뷰 남겨주셔서 감사합니다.',NOW(), NOW(), NULL),
    (gen_random_uuid(), (SELECT review_seq FROM reviews r JOIN orders o ON r.order_seq=o.order_seq WHERE o.order_seq=(SELECT id FROM order_map WHERE code='ORDER010')),  2, '더 발전하는 매장이 되겠습니다.', NOW(), NOW(), NULL);

----------------------------
-- 14) 매장 이미지 (store_images)
----------------------------
INSERT INTO store_images (store_image_seq, store_id, store_image_url, created_date, modified_date, deleted_date)
VALUES
